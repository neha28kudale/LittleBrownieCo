...
export const Route = createFileRoute("/_site/contact")({
  head: () => ({
    meta: [
      { title: "Contact & FAQs — Little Brownie Co." },
      {
        name: "description",
        content:
          "Get in touch with Little Brownie Co. in Bengaluru — WhatsApp, phone, email or Instagram — plus answers to frequently asked questions.",
      },
    ],
  }),
  component: Contact,
  ...
  return (
    <>
      <section className="container-x pt-10 pb-6 md:pt-16 md:pb-8">
        <span className="text-[11px] uppercase tracking-[0.28em] text-toffee">Contact & FAQs</span>
      ...
      <section className="container-x grid gap-4 pb-14 md:grid-cols-2 md:gap-5 lg:max-w-4xl">
        <a
        ...
        >
          ...
          <h2 className="mt-3 font-serif text-xl text-primary group-hover:text-accent">
            WhatsApp
          </h2>
        ...
        <div className="rounded-lg border border-border bg-card p-5">
          ...
          <h2 className="mt-3 font-serif text-xl text-primary">Phone</h2>
        ...
        <div className="rounded-lg border border-border bg-card p-5">
          ...
          <h2 className="mt-3 font-serif text-xl text-primary">Email</h2>
        ...
        <div className="rounded-lg border border-border bg-card p-5 md:col-span-2">
          ...
          <h2 className="mt-3 font-serif text-xl text-primary">Location</h2>
