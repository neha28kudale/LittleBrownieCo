...
//
// Full checkout page component, kept in a plain (non-route) module on
// purpose. TanStack Start's automatic route code-splitting inspects
// route files under src/routes and, on a file this size/shape, was
// generating a corrupted split that re-declared `Route` — causing a
// "Identifier 'Route' has already been declared" build failure. Moving
// all the actual page logic here (a normal component, no `Route`
// export) sidesteps that entirely; src/routes/_site/checkout.tsx now
// just re-exports the route pointing at this component.
